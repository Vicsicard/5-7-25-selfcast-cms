...
// Client management page - using string concatenation instead of template literals
router.get('/manage-clients', (req, res) => {
  ...
  const html = '<!DOCTYPE html>' +
    ...
    '        ' +
    '        // Success' +
    '        showMessage("Client " + (name || email) + " created successfully!", "success");' +
    '        ' +
    '        // Clear form' +
    ...
    '            window.open("/preview/" + client._id, "_blank");' +
    '          });' +
    '          ' +
    ...
    '        clientListElement.innerHTML = "<p>Error loading clients</p>";' +
    '      }' +
    '    }' +
    '    ' +
